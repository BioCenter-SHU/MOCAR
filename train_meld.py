"""Train or evaluate MOCAR on the seven-class MELD task."""
...
def get_MELD_loaders(data_path, batch_size=32, valid=0.1, num_workers=0, pin_memory=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=6.060121798709486e-6, metavar='LR', help='learning rate')
    parser.add_argument('--l2', type=float, default=1.6749607640937186e-5, metavar='L2', help='L2 regularization weight')
    parser.add_argument('--dropout', type=float, default=0.55, metavar='dropout', help='dropout rate')
    ...
    parser.add_argument('--data-path', default='data/meld_multimodal_features.pkl', help='pre-extracted feature pickle')
    parser.add_argument('--seed', type=int, default=10068, help='random seed')
    parser.add_argument('--save-best-dir', default='outputs/meld/checkpoints', help='directory for best checkpoint')
    parser.add_argument('--log-dir', default='outputs/meld/logs', help='directory for console logs')
    ...
    parser.add_argument('--conf-beta', type=float, default=0.70,
    ...
    parser.add_argument('--conf-warmup', type=int, default=3,
                        help='epochs for updating confusion matrices without adding MOCAR loss')

    parser.add_argument('--car-lambda', type=float, default=0.015,
                        help='weight for modality-wise CAR spectral regularizer')

    parser.add_argument('--pair-margin-lambda', type=float, default=0.020,
    ...
    parser.add_argument('--margin-scale', type=float, default=0.5,
                        help='extra margin scale multiplied by online confusion score')

    parser.add_argument('--car-text-weight', type=float, default=1.2,
                        help='CAR spectral weight for text confusion matrix')

    parser.add_argument('--car-audio-weight', type=float, default=0.8,
                        help='CAR spectral weight for audio confusion matrix')

    parser.add_argument('--car-video-weight', type=float, default=0.6,
    ...
    if args.Dataset == 'MELD':
        ...
        train_loader, valid_loader, test_loader = get_MELD_loaders(args.data_path, valid=0.0,
                                                                   batch_size=batch_size,
                                                                   num_workers=0)
