"""Train or evaluate MOCAR on the six-class IEMOCAP task."""
...
def get_IEMOCAP_loaders(data_path, batch_size=32, valid=0.1, num_workers=0, pin_memory=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', default='data/iemocap_multimodal_features.pkl', help='pre-extracted feature pickle')

    parser.add_argument('--lr', type=float, default=9.262399152486561e-5, metavar='LR', help='learning rate')
    parser.add_argument('--l2', type=float, default=6.662349508864241e-6, metavar='L2', help='L2 regularization weight')
    ...
    parser.add_argument('--save-best-dir', default='outputs/iemocap6/checkpoints', help='directory for best checkpoint')
    parser.add_argument('--log-dir', default='outputs/iemocap6/logs', help='directory for console logs')
    ...
    parser.add_argument('--car-lambda', type=float, default=0.075,
    ...
    if args.Dataset == 'MELD':
        ...
        train_loader, valid_loader, test_loader = get_IEMOCAP_loaders(args.data_path, valid=0.0,
                                                                      batch_size=batch_size,
                                                                      num_workers=0)
    else:
